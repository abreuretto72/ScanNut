...
class AppDesign {
  ...
  // CORES DOS DOMÍNIOS
  static const Color foodOrange =
      Color(0xFFFF9800); // Laranja Comida (Corrected)
  ...
  static Color getModeColor(int modeIndex) {
    switch (modeIndex) {
      case 0:
        return foodOrange; // Food (Laranja)
      case 1:
        return plantGreen; // Plant (Verde)
      case 2:
        return petPink; // Pet (Rosa)
      case 3:
        return walkBlue; // Walk (Azul)
      default:
        return textPrimaryDark; // Neutro se nenhum selecionado
    }
  }
