              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      child: const Icon(Icons.star,
                          color: _scanNutProColor, size: 48),
                    ),
                  ),
                  ...
                  if (_isLoading && _offerings == null)
                    const Center(
                        child:
                            CircularProgressIndicator(color: _scanNutProColor))
                  else if (_offerings?.current != null) ...[
                    if (_offerings!.current!.annual != null)
                      _buildPackageOption(_offerings!.current!.annual!,
                          isBestValue: true),
                    const SizedBox(height: 12),
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      foregroundColor:
                          Colors.black, // Dark text on light pink for contrast
                      padding: const EdgeInsets.symmetric(vertical: 16),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12),
                      ),
                      disabledBackgroundColor:
                          _scanNutProColor.withValues(alpha: 0.3),
                    ),
                    child: _isLoading
                        ? const SizedBox(
                            height: 24,
  ...
  Widget _buildPackageOption(Package package, {bool isBestValue = false}) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? _scanNutProColor.withValues(alpha: 0.15)
            ...
            Container(
              ...
              child: isSelected
                  ? const Icon(Icons.check,
                      size: 16, color: Colors.black) // Dark icon on pink
                  : null,
            ),
