  ...
  Future<void> _deleteSelected() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Excluir $count arquivos?',
            style: GoogleFonts.poppins(
                color: Colors.white, fontWeight: FontWeight.bold)),
        content: Text(
            'Os registros na agenda NÃO serão apagados, mas os arquivos físicos serão removidos para liberar espaço.',
    ...
    if (confirm == true) {
      ...
      if (mounted) {
        SnackBarHelper.showSuccess(context, 'Espaço liberado com sucesso!');
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('Escaneando anexos e arquivos...',
                      style: GoogleFonts.poppins(color: Colors.white70)),
                ],
              ),
            )
          : _files.isEmpty
              ? Center(
                  child: Text('Nenhum arquivo físico encontrado para gerenciar',
