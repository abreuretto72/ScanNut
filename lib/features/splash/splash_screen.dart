...
class _SplashScreenState extends ConsumerState<SplashScreen>
  ...
  static const bool RUN_STRESS_TEST =
      false; // ❌ Desabilitado conforme solicitado
  ...
  void initState() {
    ...
    Timer(const Duration(milliseconds: 1000), () async {
      ...
      if (mounted) {
        ...
        if (mounted) {
          debugPrint(
              '🛡️ [Splash] Calling simpleAuthService.checkPersistentSession()...');
          // Tenta recuperar sessão persistente e chave mestra
          final bool isLoggedIn =
              await simpleAuthService.checkPersistentSession();
          ...
          debugPrint(
              'Auth: loggedUserEmail = ${simpleAuthService.loggedUserEmail}');
          ...
          if (FORCE_LOGIN_DEBUG) {
            ...
            if (simpleAuthService.isBiometricEnabled) {
              ...
              final bioResult =
                  await simpleAuthService.authenticateWithBiometrics();
              if (bioResult == AuthResult.success) {
                ...
                nextScreen = const LoginScreen();
                decisionLog =
                    "NAVIGATE_TO_LOGIN (Biometric Rejection/Cancel/MissingKey)";
              }
            } else {
              nextScreen = const HomeView();
                  ...
                  AnimatedBuilder(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 8),
                        _buildTag('', pets,
                            icon: Icons.pets, iconColor: AppDesign.petPink),
                      ],
                    ),
                  ),
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(Icons.auto_awesome,
                            color: AppDesign.foodOrange, size: 16),
                        const SizedBox(width: 8),
                        Text(
                          poweredBy,
                          style: GoogleFonts.poppins(
