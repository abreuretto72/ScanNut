...
class PetEvent extends HiveObject {
  ...
  String getLocalizedTypeLabel(AppLocalizations strings) {
    switch (type) {
      ...
      case EventType.food:
        return strings.petEvent_group_food;
      case EventType.elimination:
        return strings.petEvent_group_elimination;
      case EventType.activity:
        return strings.petEvent_group_activity;
      case EventType.behavior:
        return strings.petEvent_group_behavior;
      case EventType.media:
        return strings.petEvent_group_media;
      case EventType.metrics:
        return strings.petEvent_group_metrics;
      case EventType.documents:
        return strings.petEvent_group_documents ?? 'Documentos';
      case EventType.exams:
        return strings.petEvent_group_exams ?? 'Exames';
      case EventType.dentistry:
        return strings.petEvent_group_dentistry ?? 'Dentição';
      case EventType.parasite:
