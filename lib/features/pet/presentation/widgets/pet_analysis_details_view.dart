...
class PetAnalysisDetailsView extends StatelessWidget {
  ...
  const PetAnalysisDetailsView(
      {super.key, required this.result, this.imagePath, this.imageFile});
              ...
              children: [
                ...
                _buildAccordion(
                    ...
                    content: Column(
                      ...
                      children: [
                        _buildCheckItem(
                            '${l10n.petSize}: ${result.identificacao.porteEstimado}'),
                        _buildCheckItem(
                            '${l10n.petCoatType}: ${result.higiene.manutencaoPelagem['tipo_pelo'] ?? 'Normal'}'),
                        if (result.descricaoVisualDiag != null &&
                            result.descricaoVisualDiag!.isNotEmpty)
                ...
                _buildAccordion(
                    ...
                    content: Column(
                      children: [
                        _buildDataRow(
                            l10n.petMetaPuppy,
                            result.nutricao.metaCalorica['kcal_filhote'] ??
                                l10n.petNoData),
                        _buildDataRow(
                            l10n.petMetaAdult,
                            result.nutricao.metaCalorica['kcal_adulto'] ??
                                l10n.petNoData),
                        _buildDataRow(
                            l10n.petMetaSenior,
                            result.nutricao.metaCalorica['kcal_senior'] ??
                                l10n.petNoData),
                        const Divider(color: Colors.white12),
                        Align(
                            alignment: Alignment.centerLeft,
                            child: Text('${l10n.petTargetNutrients}:',
                        ...
                        Wrap(
                          spacing: 6,
                          runSpacing: 6,
                          children: result.nutricao.nutrientesAlvo
                              .map((n) => Container(
                ...
                _buildAccordion(
                    ...
                    content: Column(
                      children: [
                        _buildDataRow(
                            l10n.petCoatType,
                            result.higiene.manutencaoPelagem['tipo_pelo']
                                    ?.toString() ??
                                l10n.petNoData),
                        _buildDataRow(
                            l10n.petBrushingFreq,
                            result
                                    .higiene
                                    .manutencaoPelagem[
                ...
                _buildAccordion(
                    ...
                    content: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('${l10n.petPredispositions}:',
                            style: const TextStyle(
                                color: AppDesign.accent, fontSize: 12)),
                        ...result.saude.predisposicaoDoencas.map((e) => Padding(
                ...
                _buildAccordion(
                    ...
                    content: Column(
                      children: [
                        _buildDataRow(
                            l10n.petEnergy,
                            result.perfilComportamental.nivelEnergia > 0
                                ? '${result.perfilComportamental.nivelEnergia}/5'
                                : 'Moderado'),
                        _buildDataRow(
                            l10n.petIntelligence,
                            result.perfilComportamental.nivelInteligencia > 0
                                ? '${result.perfilComportamental.nivelInteligencia}/5'
                                : 'Média'),
                        _buildDataRow(l10n.petDrive,
                            result.perfilComportamental.driveAncestral),
                      ],
                    )),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(children: [
                        ...
                        Text(l10n.petInsightSpecialist,
                            style: const TextStyle(
                                color: AppDesign.petPink,
                      ...
                      const SizedBox(height: 8),
                      Text(
                        result.dica.insightExclusivo.isNotEmpty
                            ? result.dica.insightExclusivo
                            : 'Mantenha vacinas em dia e proporcione uma dieta balanceada para longevidade.',
                        style: const TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              if (result.identificacao.racaPredominante != 'N/A')
                Text(result.identificacao.racaPredominante,
                    style: const TextStyle(
                        color: AppDesign.accent, fontWeight: FontWeight.w500)),
              const SizedBox(height: 4),
              Text(
                  '${result.identificacao.porteEstimado} • ${result.identificacao.expectativaVidaMedia}',
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          Expanded(
              child: Text(l10n.petDisclaimerAI,
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        title: Text(title,
            style: const TextStyle(
                color: Colors.black,
                fontWeight: FontWeight.w600)), // Changed to Black
          ...
          Expanded(
              child: Text(text,
                  style: const TextStyle(
                      ...
                      fontSize: 13))), // Changed to Black87
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label,
              style: const TextStyle(
                  color: Colors.black54, fontSize: 13)), // Changed to Black54
          Flexible(
              child: Text(value,
                  style: const TextStyle(
                      color: Colors.black,
                      ...
                      fontSize: 13),
                  textAlign: TextAlign.right)), // Changed to Black
        ],
      ),
    );
  }
