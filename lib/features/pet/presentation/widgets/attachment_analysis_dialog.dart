  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(children: [
        ...
        Expanded(
            child: Text(l10n.analysis_title ?? 'Resultado da Análise IA',
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (data['alerts'] != null &&
              ...
              const Text("ALERTAS",
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.bold,
                      fontSize: 12)),
              ...(data['alerts'] as List).map((a) => Text("• $a",
            ...
            if (data.isEmpty)
              const Text("Sem dados estruturados.",
      ...
      actions: [
        TextButton(
            ...
            child: Text(l10n.btn_close ?? "Entendi",
