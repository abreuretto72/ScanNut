...
class _PetEventBottomSheetState extends State<PetEventBottomSheet> {
  ...
  Future<void> _pickFile(String kind, String prefix) async {
    ...
    try {
      if (kind == 'camera') {
        ...
        file = await service.pickFromGallery();
      ...
      if (finalPath != null && mounted) {
        ...
        if (friendlyName != null && friendlyName.isNotEmpty) {
          ...
          // Sanitize name
          final cleanName =
              friendlyName.replaceAll(RegExp(r'[<>:"/\\|?*]'), '').trim();
    ...
    return showDialog<String>(
        ...
        builder: (ctx) {
          return AlertDialog(
            ...
            title: Text(l10n.petAttachmentNameTitle,
            ...
            actions: [
              TextButton(
                  onPressed: () => Navigator.pop(ctx,
                      null), // Cancel returns null (means keep default or cancel?)
              ...
              ElevatedButton(
                  ...
                  onPressed: () => Navigator.pop(
                      ctx, imageName.isEmpty ? 'Anexo' : imageName),
                  child:
  ...
  void _showCategoryHelp(BuildContext context) {
    ...
    switch (widget.groupId) {
      case 'food':
        title = 'Alimentação';
        helpText =
            "Registre trocas de ração, petiscos novos ou dietas naturais. Anexe fotos da embalagem ou do prato.";
        break;
      case 'health':
        title = 'Saúde';
        helpText =
            "Registre sintomas, feridas ou mal-estar. Anexe fotos de lesões para análise clínica.";
        break;
      case 'elimination':
        title = 'Fezes/Urina';
        helpText =
            "Monitore alterações de cor ou consistência. Anexe fotos para identificação de anomalias.";
        break;
      case 'medication':
        title = 'Medicação';
        helpText =
            "Registre receitas e horários. Anexe a bula ou a receita física para leitura por IA.";
        break;
      case 'grooming':
        title = 'Higiene';
        helpText =
            "Banhos, tosas e corte de unhas. Monitore a frequência e alergias a shampoos.";
        break;
      case 'activity':
        title = 'Atividade';
        helpText =
            "Passeios, treinamentos e exercícios físicos. Registre o progresso e o cansaço.";
        break;
      case 'behavior':
        title = 'Comportamento';
        helpText =
            "Mudanças de humor, medo ou agressividade. Útil para identificar gatilhos de estresse.";
        break;
      case 'schedule':
        title = 'Agenda';
        helpText =
            "Lembretes de retorno ao veterinário, check-ups ou compromissos futuros.";
        break;
      case 'documents':
        title = 'Documentos';
        helpText =
            "Guarde RGs, Pedigrees, microchips e contratos de compra/adoção.";
        break;
      case 'exams':
        title = 'Exames';
        helpText =
            "Anexe aqui resultados de sangue, urina ou imagem. A IA extrairá os dados técnicos.";
        break;
      case 'allergies':
        title = 'Alergias';
        helpText =
            "Registre reações alérgicas e coceiras. Ajuda a identificar padrões sazonais ou alimentares.";
        break;
      case 'dentistry':
        title = 'Odontologia';
        helpText =
            "Saúde bucal: tártaro, gengivas e dentes. Anexe fotos da boca para monitoramento.";
        break;
      case 'metrics':
        title = 'Métricas';
        helpText =
            "Acompanhe peso, altura e medidas corporais. Gere gráficos de crescimento.";
        break;
      case 'media':
        title = 'Mídia/Fotos';
        helpText =
            "Galeria de fotos e vídeos do pet. Registre momentos especiais.";
        break;
      case 'other':
        title = 'Outros';
        helpText =
            "Qualquer registro geral que não se encaixe nas categorias acima.";
        break;
      default:
        title = widget.groupLabel;
        helpText =
            "Anexe arquivos e descreva o evento para manter o histórico do pet completo.";
    }
    ...
    showDialog(
        ...
        builder: (ctx) => AlertDialog(
              ...
              content: Text(helpText,
                  style: const TextStyle(
                      color: Colors.white70, height: 1.5, fontSize: 16)),
              actions: [
                TextButton(
                    onPressed: () => Navigator.pop(ctx),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: MediaQuery.of(context).size.height *
          0.85, // Fixed height for consistency
      child: Stack(
        children: [
          Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.hourglass_empty,
                          color: AppDesign.petPink, size: 80),
                      ...
                      Container(
                        ...
                        child: const Text("Analisando imagem",
                            style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                                fontSize: 18)),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            _buildAttachBtn(
                Icons.camera_alt, 'Câmera', () => _pickFile('camera', 'F')),
            _buildAttachBtn(Icons.photo_library, 'Galeria',
                () => _pickFile('gallery', 'G')),
            _buildAttachBtn(
                Icons.description, 'Arquivo', () => _pickFile('file', 'A')),
          ],
        ),
              ...
              return Container(
                ...
                child: FutureBuilder<String>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final isBroken = currentPath == 'REMOVED_BY_SANITIZER' ||
                          ...
                          child: InkWell(
                            onTap: isSidecar
                                ? () {
                                    try {
                                      final content =
                                          File(a.path).readAsStringSync();
                                      AttachmentAnalysisDialog.show(
                                          context, content);
                                    } catch (e) {
  ...
  Widget _buildDynamicFields() {
    ...
    switch (widget.groupId) {
      ...
      case 'metrics':
        return Column(
          children: [
            _buildTextField('peso', 'Peso (kg)',
                keyboardType: TextInputType.number, icon: Icons.monitor_weight),
            const SizedBox(height: 12),
      ...
      case 'activity':
        return Column(
          children: [
            _buildTextField('duracao', 'Duração (minutos)',
                keyboardType: TextInputType.number, icon: Icons.timer),
            const SizedBox(height: 12),
            _buildChipsField(
                'intensidade', 'Intensidade', ['Leve', 'Moderada', 'Intensa']),
          ],
        );
      case 'elimination':
        return Column(
          children: [
            _buildChipsField(
                'tipo_el', 'Ocorrência', ['Fezes', 'Urina', 'Vômito']),
            const SizedBox(height: 12),
            _buildTextField('consistencia', 'Consistência / Cor',
      ...
      case 'grooming':
        return Column(
          children: [
            _buildTextField('produto', 'Produto utilizado',
                icon: Icons.cleaning_services),
            const SizedBox(height: 12),
            _buildChipsField(
                'reacao', 'Reação', ['Calmo', 'Agitado', 'Apreensivo']),
          ],
        );
      case 'behavior':
        return Column(
  ...
  Widget _buildHealthEventFields() {
      ...
      try {
        ...
        switch (eventType) {
          case 'temperature_check':
            return l10n.health_type_temperature_check;
          case 'weight_check':
            return l10n.health_type_weight_check;
          case 'appetite_monitoring':
            return l10n.health_type_appetite_monitoring;
          case 'hydration_check':
            return l10n.health_type_hydration_check;
          case 'energy_level':
            return l10n.health_type_energy_level;
          case 'behavior_observation':
            return l10n.health_type_behavior_observation;
          case 'fever':
            return l10n.health_type_fever;
          case 'vomiting':
            return l10n.health_type_vomiting;
          case 'diarrhea':
            return l10n.health_type_diarrhea;
          case 'lethargy':
            return l10n.health_type_lethargy;
          case 'loss_of_appetite':
            return l10n.health_type_loss_of_appetite;
          case 'excessive_thirst':
            return l10n.health_type_excessive_thirst;
          case 'difficulty_breathing':
            return l10n.health_type_difficulty_breathing;
          case 'coughing':
            return l10n.health_type_coughing;
          case 'sneezing':
            return l10n.health_type_sneezing;
          case 'nasal_discharge':
            return l10n.health_type_nasal_discharge;
          case 'suspected_infection':
            return l10n.health_type_suspected_infection;
          case 'wound_infection':
            return l10n.health_type_wound_infection;
          case 'ear_infection':
            return l10n.health_type_ear_infection;
          case 'eye_infection':
            return l10n.health_type_eye_infection;
          case 'urinary_infection':
            return l10n.health_type_urinary_infection;
          case 'parasite_detected':
            return l10n.health_type_parasite_detected;
          case 'tick_found':
            return l10n.health_type_tick_found;
          case 'flea_infestation':
            return l10n.health_type_flea_infestation;
          case 'skin_rash':
            return l10n.health_type_skin_rash;
          case 'itching':
            return l10n.health_type_itching;
          case 'hair_loss':
            return l10n.health_type_hair_loss;
          case 'hot_spot':
            return l10n.health_type_hot_spot;
          case 'wound':
            return l10n.health_type_wound;
          case 'abscess':
            return l10n.health_type_abscess;
          case 'allergic_reaction':
            return l10n.health_type_allergic_reaction;
          case 'swelling':
            return l10n.health_type_swelling;
          case 'limping':
            return l10n.health_type_limping;
          case 'joint_pain':
            return l10n.health_type_joint_pain;
          case 'difficulty_walking':
            return l10n.health_type_difficulty_walking;
          case 'stiffness':
            return l10n.health_type_stiffness;
          case 'muscle_weakness':
            return l10n.health_type_muscle_weakness;
          case 'fall':
            return l10n.health_type_fall;
          case 'fracture_suspected':
            return l10n.health_type_fracture_suspected;
          case 'seizure':
            return l10n.health_type_seizure;
          case 'tremors':
            return l10n.health_type_tremors;
          case 'disorientation':
            return l10n.health_type_disorientation;
          case 'loss_of_balance':
            return l10n.health_type_loss_of_balance;
          case 'vision_problems':
            return l10n.health_type_vision_problems;
          case 'hearing_problems':
            return l10n.health_type_hearing_problems;
          case 'head_tilt':
            return l10n.health_type_head_tilt;
          case 'medication_administered':
            return l10n.health_type_medication_administered;
          case 'vaccine_given':
            return l10n.health_type_vaccine_given;
          case 'wound_cleaning':
            return l10n.health_type_wound_cleaning;
          case 'bandage_change':
            return l10n.health_type_bandage_change;
          case 'vet_visit':
            return l10n.health_type_vet_visit;
          case 'surgery':
            return l10n.health_type_surgery;
          case 'emergency_care':
            return l10n.health_type_emergency_care;
          case 'hospitalization':
            return l10n.health_type_hospitalization;
          default:
            return eventType;
        }
      } catch (_) {
    ...
    final isEmergencyEvent = selectedEventType != null &&
        emergencyEvents.contains(selectedEventType);
        ...
        Expanded(
          child: DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon:
                  const Icon(Icons.place, color: Colors.white30, size: 18),
              filled: true,
              fillColor: AppDesign.backgroundDark,
              border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
            ...
            onChanged: (val) {
              if (val != null) {
                ...
                setState(() {
                  ...
                  _dynamicData['local'] = partner
                      .name; // For backward compatibility with UI that shows 'local'
                });
              }
            },
            hint: Text(
  ...
  Widget _buildTextField(String key, String label,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelStyle: const TextStyle(color: Colors.white30, fontSize: 12),
        prefixIcon:
            icon != null ? Icon(icon, color: Colors.white30, size: 18) : null,
        filled: true,
        fillColor: AppDesign.backgroundDark,
        border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
    ...
    final mode = await showDialog<ScannutMode>(
      ...
      builder: (ctx) => SimpleDialog(
        ...
        title: Row(children: [
          ...
          const SizedBox(width: 8),
          Expanded(
              child: Text(l10n.petAttachmentAnalyzeTitle,
                  style: const TextStyle(color: Colors.white, fontSize: 18))),
        ]),
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 8),
            child: Text(l10n.petAttachmentAnalyzeQuestion,
          ...
          SimpleDialogOption(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                    child: Text(l10n.petAttachmentOptionPhoto,
                        style: const TextStyle(
          ...
          SimpleDialogOption(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                    child: Text(l10n.petAttachmentOptionOCR,
                        style: const TextStyle(
                            color: Colors.white, fontSize: 16))),
              ]),
            ),
  ...
  Future<void> _analyzeAttachment(
      AttachmentModel attachment, ScannutMode mode) async {
    final l10n = AppLocalizations.of(context)!;
    ...
    try {
      ...
      if (hash.isNotEmpty) {
        ...
        if (existing != null) {
          debugPrint(
              '🚫 [EventAttachment] [DEDUPLICATION] Match found. Stopping.');
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      try {
        final imageFile = File(attachment.path);
        sidecarFilePath = path.join(imageFile.parent.path,
        ...
        } else if (widget.groupId.contains('health'))
          category = MediaVaultService.WOUNDS_DIR;

        final safePetName =
            widget.petId.replaceAll(RegExp(r'\s+'), '_').toLowerCase();

        // We manually place it in the backup mirror to ensure "Absolute Retention"
        final appDir = await getApplicationSupportDirectory();
        final backupRoot = Directory(
            '${appDir.path}/ScanNut_Safe_Backup/$category/$safePetName');
        if (await backupRoot.exists()) {
          final backupResultPath = path.join(backupRoot.path,
              "${path.basenameWithoutExtension(imageFile.path)}_ResuAnalise.json");
  ...
  String _parseAttachmentName(String filePath) {
    ...
    return filename
        .replaceFirst(RegExp(r'^\d{8}_\d{6}_[A-Z]_'), '')
