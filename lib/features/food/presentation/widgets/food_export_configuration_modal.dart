...
class FoodExportConfigurationModal extends StatefulWidget {
  ...
  @override
  State<FoodExportConfigurationModal> createState() =>
      _FoodExportConfigurationModalState();
}

class _FoodExportConfigurationModalState
    extends State<FoodExportConfigurationModal> {
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                      child: Text('Exportar Histórico PDF',
              ...
              if (_manualSelectionMode) ...[
                ...
                Container(
                  ...
                  child: filteredList.isEmpty
                      ? const Center(
                          child: Text('Nenhum item neste período.',
