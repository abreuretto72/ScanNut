...
class _FitnessDashboardScreenState extends State<FitnessDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(l10n.fitnessDashboardTitle,
                    ...
                    children: [
                      Expanded(
                          child: _buildInfoCard(
                              l10n.fitnessConsumed,
                              '${_consumed.toInt()} kcal',
                              Icons.restaurant,
                              Colors.orangeAccent)),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(l10n.fitnessMetaDaily(_goal.toInt().toString()),
  ...
  void _showAddWorkoutDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(l10n.fitnessRegWorkout,
            style: GoogleFonts.poppins(color: Colors.white)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildDialogField(
                nameCtrl, l10n.fitnessExerciseHint, Icons.directions_run),
            const SizedBox(height: 12),
            _buildDialogField(
                calCtrl, l10n.fitnessCaloriesHint, Icons.local_fire_department,
                keyboard: TextInputType.number),
            const SizedBox(height: 12),
            _buildDialogField(durCtrl, l10n.fitnessDurationHint, Icons.timer,
                keyboard: TextInputType.number),
          ],
        ),
        actions: [
